...
//
//  Device-local folder groups for the chat-folder rail. Telegram folders stay
//  flat; these parents only nest them in the left rail on this device.
//
...
///
/// Identity is the account's user id (same pattern as [LocalChatPinStore]).
class LocalFolderGroupStore extends ChangeNotifier {
  ...
  /// Ensures the group that owns [folderId] is expanded so the rail can show
  /// the selected leaf.
